...
| 				| 256			| 0.5249 | 0.3887	| 0.3996	| 0.428	|
| 				| 512			| 0.534	 | 0.442	| 0.3997	| 0.38	|
| **25** 		| 128			| 0.506	 | 0.4307	| 0.4813	| 0.5373	|
| 				| 256			| 0.5322 | 0.4185	| 0.4021	| 0.4261	|
| 				| 512			| 0.5596 | 0.4495	| 0.438		| 0.4126	|
...
As for batch sizes, we see the best performance on `25` if the RNN size is only `128`. For larger networks, batch size `50` performs better. 
